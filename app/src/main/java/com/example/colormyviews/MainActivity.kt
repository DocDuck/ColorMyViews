...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clickableViews: List<View> =
            listOf(box_one_text, box_two_text, box_three_text,
                box_four_text, box_five_text, button_red, button_yellow, button_green)
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            // Boxes using a custom color defined in color.xml
            R.id.button_red -> box_three_text.setBackgroundResource(R.color.colorRed)
            R.id.button_yellow -> box_four_text.setBackgroundResource(R.color.colorYellow)
            R.id.button_green -> box_five_text.setBackgroundResource(R.color.colorGreen)
